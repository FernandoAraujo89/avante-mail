...
import { realcarHtml, type TipoDeToken } from "@/lib/email-builder/realce";
 ...
 * escuro sempre, independente do tema da aplicação. É a mesma escolha que o
 * VS Code embutido faz nas ferramentas de e-mail — código se lê em fundo
 ...
 *
 * A régra que faz isso funcionar: as duas camadas precisam quebrar linha
        ...
        {tokens.map((token, i) => (
          <span
            ...
            style={{
              ...
              fontStyle: ITALICO[token.tipo] ? "italic" : undefined,
            }}
          >
            {token.texto}
          </span>
